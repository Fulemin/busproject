  ...
  <div>
    ...
    <div class="content">
      <div class="contenttext">
        ...
        <div>
          <van-cell-group>
            <van-field v-model="passengerName" required clearable label="姓名" placeholder="请输入您的姓名" />
          </van-cell-group>
        </div>
        <div>
          <van-cell-group>
            <van-field v-model="phone" required clearable label="手机号" placeholder="请输入您的手机号" />
          </van-cell-group>
        </div>
        <div class="contentexttype">
...
export default {
  ...
  methods: {
    save() {
      ...
      // let m = {"passengerPhone":this.phone};
      let m = {
        passengerName: this.passengerName,
        passengerPhone: this.phone,
        passengerIdCard: this.idCard,
        passengerType: this.type,
        tokenId:JSON.parse(localStorage.getItem("user")).tokenId
      };
      ...
      t.axios
        .post(this.baseurl + "/addPassengers", m)
